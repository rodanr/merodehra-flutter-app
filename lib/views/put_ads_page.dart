                    ...
                    children: [
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration:
                              new InputDecoration(hintText: "Number of rooms"),
                        ),
                        flex: 5,
                      ),
                    ],
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        flex: 3,
                        child: DropdownButton<String>(
                          value: selectedBathroomUsage == BathroomUsage.private
                              ? "Private"
                              : "Shared",
                          style: TextStyle(color: Colors.white, fontSize: 20.0),
                          underline: Container(
                          ...
                          onChanged: (String newValue) {
                            setState(() {
                              if (newValue == "Private") {
                                ...
                                setState(() {
                                  selectedBathroomUsage = BathroomUsage.shared;
                                });
                              }
                              // print(selectedPropertyType);
                            });
                          },
                          items: <String>['Private', 'Shared']
                              .map<DropdownMenuItem<String>>((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
